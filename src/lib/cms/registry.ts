...
export const PAGES: PageDef[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "hero.title",   label: "Hero title",     default: "Six pieces.\nOne logic.", wired: true, multiline: true },
      { id: "hero.subtitle",label: "Hero subtitle",  default: "A modular wardrobe architecture. Six pieces, one logic, no restocks.", wired: true, multiline: true },
      { id: "intro",        label: "Intro paragraph",default: "Every piece in the Forme collection is resolved against the others — cut, weight, hem. Wear any combination.", wired: true, multiline: true },
    ],
  },
  {
    id: "contact",
